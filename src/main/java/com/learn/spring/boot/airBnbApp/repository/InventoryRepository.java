...
public interface InventoryRepository extends JpaRepository<Inventory, Long> {
    ...
    @Query("""
            ...
            """)
    @Lock(LockModeType.PESSIMISTIC_WRITE)
    public List<Inventory> findAndLockReservedInventory(@Param("roomId") Long roomId,
                                                 @Param("startDate") LocalDate startDate,
                                                 @Param("endDate") LocalDate endDate,
    ...
    @Query("""
       SELECT new com.learn.spring.boot.airBnbApp.dto.RoomPriceDto(
            i.room,
            CASE
                WHEN COUNT(DISTINCT i.date) = :dateCount THEN AVG(i.price)
                ELSE NULL
            END
       )
       FROM Inventory i
